...
// Stem стеммирует один токен и возвращает его основу. Токен ожидается уже
// приведённым через Fold. Экспортированная обёртка над stemToken нужна тем,
// кто ищет совпадение словоформ вне индекса, - например, чтобы подсветить
// или центрировать сниппет на слове запроса в исходном тексте чанка.
